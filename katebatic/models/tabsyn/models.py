...
from katebatic.models.base_model import Model as BaseModel
from .utils import (
    TabSynConfig,
    TabSynState,
    train_tabsyn,
...
class TabSyn(BaseModel):
    ...
    def get_required_dependencies(cls) -> list[str]:
        # Core libs like numpy/pandas are assumed already in katebatic.
    ...
    def train(
        ...
        **kwargs
        ...
        try:
            ...
            print(f"[TabSyn] Warning: could not align feature names using {real_x_train_path}: {e}")
