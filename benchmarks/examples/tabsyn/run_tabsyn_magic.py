...
# Katabatic/benchmarks/examples/tabsyn/run_tabsyn_magic.py
#
...
# These imports must be after the project path setup.
...
def prepare_tabsyn_data(
    ...
    """Create the NumPy files required by the TabSyn utility code."""
    ...
    # Magic has no categorical feature columns.
...
# ============================================================
# CONVERT TABSyn OUTPUT TO MAGIC DATASET FORMAT
# ============================================================
...
def convert_tabsyn_output(
    ...
    """Convert TabSyn output back to the Magic dataset schema."""
    ...
    for index, column in enumerate(continuous_cols):
        ...
        # Magic features are integer-valued in your dataset.
        values = values.round()

        # Keep generated values within the observed real range.
        values = values.clip(
    ...
    # Restore exact Magic dataset column order.
...
# Create NumPy files required by TabSyn utils.py.
prepare_tabsyn_data(
    train_df,
    test_df,
    target_col,
