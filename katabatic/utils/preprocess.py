"""Tabular preprocessing utilities for discrete/categorical synthesis pipelines."""
...
def _cli_main() -> None:
    ...
    parser.add_argument(
        "--bins", type=int, default=10, help="Number of bins for numeric discretization"
    )
    parser.add_argument(
        "--strategy",
        type=str,
    ...
    preprocess_tabular(args.input, args.output, bins=args.bins, strategy=args.strategy)
