...
class {class_name}(Model):
    ...
    def train(
        ...
        **kwargs,
        ...
        ----------
        data_dir : str
            Path to the split directory (contains train_full.csv,
        ...
        \"\"\"
        # TODO: load data from data_dir and fit your model
        # Set self.is_fitted = True once training completes successfully.
